...
#bullet , bullet state "ready"= uh cant se bullet 
#"fire" = you can see bullet , bullet is moving 
...
while running:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state is "ready":
                    ...
                    bullet_sound.play()
                    #get current x cordinate of the ship
                    bulletX = playerX
    ...
    #add boundry to our spaceship so it can't go beyond border of screen
    if playerX <= 0:
        playerX = 0
    elif playerX >= 736:
        playerX = 736
